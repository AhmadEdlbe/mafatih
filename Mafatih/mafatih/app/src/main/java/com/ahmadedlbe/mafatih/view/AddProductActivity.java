...
import com.ahmadedlbe.mafatih.databinding.ActivityAddProductBinding;
import com.ahmadedlbe.mafatih.storage.LoginUtils;
import com.ahmadedlbe.mafatih.viewmodel.AddProductViewModel;
...
public class AddProductActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void addProduct(String pathname) {
        ...
        if (TextUtils.isEmpty(nameString) || TextUtils.isEmpty(priceString) ||
                TextUtils.isEmpty(quantityString) || TextUtils.isEmpty(categoryString)) {
