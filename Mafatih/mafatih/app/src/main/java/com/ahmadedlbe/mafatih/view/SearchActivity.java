...
import static com.ahmadedlbe.mafatih.utils.Constant.KEYWORD;
...
import com.ahmadedlbe.mafatih.adapter.WordAdapter;
import com.ahmadedlbe.mafatih.databinding.ActivitySearchBinding;
...
public class SearchActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    public static void clearSharedPreferences(Context context){
        context.getSharedPreferences(HISTORY_DATA, Context.MODE_PRIVATE).edit().apply();
    }
