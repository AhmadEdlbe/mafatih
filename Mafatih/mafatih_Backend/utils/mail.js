...
function sendOptMail(email, otpCode){
  ...
  var mailOptions = {
    ...
    to: email,
    subject: 'Mafatih Password Assistance',
    text: 'To authenticate, please use the following One Time Password (OTP): \n' + otpCode + '\nDo not share this OTP with anyone.\n Mafatih takes your account security very seriously.'+
    '\nMafatih will never ask you to disclose or varify your Mafatih password, OTP, credit card, or banking account number'
  };
